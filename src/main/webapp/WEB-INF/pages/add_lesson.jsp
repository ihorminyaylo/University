...
<form class="form-horizontal" action="/add_lesson" method="POST" id="formLesson" data-toggle="validator" role="form">
    <div class="container">
        <div class="col-md-12">
            <h1>Add subject</h1>
        </div>
    ...
    <div class="form-group">
        <label class="control-label col-sm-2" for="subjectName">Lesson name</label>
        <div class="col-sm-5">
