        ...
        <div class="row">
            <div class="col-md-4">
                <label for="subjectName">Subject name</label>
                    <select class="form-control col-md-6 <c:if test="${validation == 0}">has-error</c:if>" id="subjectName" name="newIdSubject">
            ...
            <div class="col-md-8">
                ...
                <input type="text" id="date" placeholder="SELECT DATE" name="newDate" value="${lesson.date}">
